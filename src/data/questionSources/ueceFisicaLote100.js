...
export const UECE_FISICA_LOTE_100_AUDIT={
  ...
  loteQuinto:UECE_FISICA_LOTE_401_500.length,
  ...
  opticaRestante:OPTICA_RESTANTE.length,
  ...
  withMediaNovo:UECE_FISICA_LOTE_401_500.filter(q=>q.media).length,
